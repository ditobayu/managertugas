      ...
      >
              ...
              <button
                ...
                className={`${
                  val.participant.find((val) => val.id === userData.user._id)
                    ? "hover:scale-105"
                    : ""
                } h-full w-64 md:w-96 rounded-3xl dark:bg-slate-800 duration-200`}
              ></button>
        ...
        >
          <div className="flex justify-between flex-row items-center">
            <div className="m-4 flex items-center flex-row">
              <button
                ...
                className="h-8 w-8 flex items-center justify-center rounded-full mr-4 dark:bg-slate-800"
              >
                {"<"}
              </button>
            ...
            <button
              ...
              className="flex flex-col overflow-hidden mr-8 rounded-xl justify-center hover:scale-105 duration-200 items-center h-full dark:bg-slate-800"
            >
          ...
          <div className="flex flex-col md:flex-row h-full overflow-hidden noScrollbar overflow-y-scroll">
            <div className="w-full md:w-8/12">
              <iframe
                className="rounded-lg md:rounded-[40px] h-52 sm:h-80 md:h-[500px]"
                width="100%"
                height="100%"
                src={
                  !selectedVideo
              ...
              <div className="rounded-3xl h-52 md:h-96 bg-slate-800 p-4 md:p-8 mb-4">
                <div>Catatan</div>
                ...
                <div className="flex flex-row-reverse">
                  <button className="rounded-xl text-sm md:text-md bg-slate-600 py-1 md:py-2 hover:scale-105 duration-200 px-4">
                    Save
                  </button>
                </div>
                {/* </div> */}
            ...
            <div className="w-full md:w-4/12 md:px-8 mb-16">
              {selectedChallenge?.data?.map((val, i) => (
                <button
                  key={i}
                  onClick={() => setSelectedVideo(val)}
                  className="hover:scale-105 duration-200 mb-2 md:mb-4 w-full h-24 bg-slate-800 rounded-3xl p-4 px-8 flex flex-row items-center"
                >
                  <svg
        ...
        >
          ...
          <div className="flex flex-col-reverse gap-2 md:gap-0 md:flex-row">
            <div className="w-full md:w-8/12 flex flex-col rounded-2xl mb-16 sm:mb-4 bg-slate-800 mr-4">
            ...
            <div className="w-full md:w-4/12">
              <div className="flex flex-col rounded-xl dark:bg-slate-800 p-4">
