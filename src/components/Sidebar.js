  ...
  return (
    ...
    >
      <div
        ...
        } flex sm:flex-col flex-row w-full border-y dark:border-y-slate-600 border-t-slate-300 sm:border-0 pointer-events-auto justify-center sm:justify-start absolute sm:relative bottom-0 bg-white dark:bg-slate-800 sm:rounded-3xl shadow-lg h-16 sm:h-full `}
      >
        <div
          className={`${
